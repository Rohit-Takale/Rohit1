...
export default function VendorRejectedTestsDetail(props) {
  ...
  const getTestDetails = async (vId, tId) => {
    var leadsRef = await firebase
      .database()
      .ref("ApprovedVendors/" + vId + "/RejectedTests/" + tId);
    ...
    <center>
      <Grid container className={classes.container}>
        ...
        <Grid item lg={4} xs={12}>
          ...
          <div>
            <div>
              <Typography className={classes.heading}>Rejected Test</Typography>
            </div>
            <div className={classes.sectionDesktop}>
              <Typography
