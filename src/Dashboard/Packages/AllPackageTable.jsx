...
function createData(PackageId, Packagecategory, Packagename, PackageDescription, Nooftests, Type) {
  return { PackageId, Packagecategory, Packagename, PackageDescription, Nooftests, Type };
}
...
export default function AllPackageTable() {
