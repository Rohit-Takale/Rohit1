...
import RejectedPackageTable from "./RejectedPackageTable";
...
export default function RejectedPackages() {
        ...
        <Grid container className={classes.container}>
          ...
          <Grid item lg={6}>
            <div style={{ float: "right" }}>
              <Button
                className={classes.button2}
                style={{ backgroundColor: "#4DDAF8" ,width:120}}
              >
                Update
              </Button>
            </div>
