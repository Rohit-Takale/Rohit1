...
import AllTestTable from "./AllTestTable";
import styled from "styled-components";
import ApprovedTestTable from "./ApprovedTestTable";
import RejectedTestTable from "./RejectedTestTable";
...
export default function RejectedTest() {
      ...
      <div>
        <Grid container className={classes.container}>
          <Grid item lg={12} sm={6} xs={12} md={6}>
            <div>
              <Typography
                style={{ color: "#FE3131", fontSize: 20, fontWeight: "bold" }}
              >
                Rejected Tests
              </Typography>{" "}
            </div>
